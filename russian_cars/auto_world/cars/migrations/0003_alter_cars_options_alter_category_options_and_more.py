...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='cars',
            options={'ordering': ['time_create', 'title'], 'verbose_name': 'Российские автомобили', 'verbose_name_plural': 'Российские автомобили'},
        ),
        migrations.AlterModelOptions(
            name='category',
        ...
        migrations.AlterField(
            model_name='cars',
            name='cat',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='cars.category', verbose_name='Категория'),
        ),
        migrations.AlterField(
            model_name='cars',
            name='content',
